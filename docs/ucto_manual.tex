...
Ucto depends on the \texttt{libicu} library. This library can be obtainaed from \\
{\tt http://site.icu-project.org/} but also present in the package manager of all major Linux distributions. It also depends on \texttt{libfolia}, available from \texttt{http://proycon.github.com/folia}. It will not compile without either of them.
